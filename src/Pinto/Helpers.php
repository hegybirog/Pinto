...
class Helpers
{
	...
	public static function improveException(\Throwable $e): void
	{
		...
		if (isset($replace)) {
			...
			@$e->PintoAction = [ // dynamic properties are deprecated since PHP 8.2
	...
	public static function isHtmlMode(): bool
	{
		return empty($_SERVER['HTTP_X_REQUESTED_WITH'])
			&& empty($_SERVER['HTTP_X_Pinto_AJAX'])
	...
	{
		return isset($_SERVER['HTTP_X_Pinto_AJAX']) && preg_match('#^\w{10,15}$#D', $_SERVER['HTTP_X_Pinto_AJAX']);
	}
